...
public static class ProcessUtil
{
    ...
    public static IList<ProcessInfoViewModel> LoadProcesses()
    {
        ...
        {
            OrderedParallelQuery<ProcessInfoViewModel> processInfoList = WmiUtil.QueryProcesses().AsParallel()
                                                      .Select(BuildProcessInfo)
    ...
    private static IList<ProcessModuleInfo> GetProcessModuleInfos(ProcessInfoViewModel result)
    {
        ...
        return [.. modules.Select(m => new ProcessModuleInfo { Name = m })];
    }
    private static IList<ProcessModuleInfo> GetProcessModuleInfos(Process process, ProcessInfoViewModel processInfoViewModel)
    {
        ...
        try
        {
            ...
            {
                return [.. process.Modules.OfType<ProcessModule>().Select(m => new ProcessModuleInfo { Name = m.ModuleName })];
            }
            else
            {
