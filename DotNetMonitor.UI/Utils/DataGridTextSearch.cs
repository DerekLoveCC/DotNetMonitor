...
namespace DotNetMonitor.UI.Utils
{
    public static class DataGridTextSearch
    {
        ...
        public static readonly DependencyProperty IsTextMatchProperty = DependencyProperty.RegisterAttached("IsTextMatch", typeof(bool), typeof(DataGridTextSearch), new UIPropertyMetadata(false));
